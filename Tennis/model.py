...
class Critic(nn.Module):
    ...
    def __init__(self, n_agents, state_size, action_size, seed, fcs1_units=128, fc2_units=128):
        """Initialize parameters and build model.
        Params
        ======
            state_size (int): Dimension of each state
        ...
        self.seed = torch.manual_seed(seed)
        self.fcs1 = nn.Linear(state_size*n_agents, fcs1_units*n_agents)
        self.fc2 = nn.Linear((fcs1_units+action_size)*n_agents, fc2_units)
        self.fc3 = nn.Linear(fc2_units, 1)
        self.bn1 = nn.BatchNorm1d(fcs1_units*n_agents)
        self.bn2 = nn.BatchNorm1d(fc2_units)
        self.reset_parameters()
...
class Actor_Critic_Models():
    ...
    def __init__(self, n_agents, state_size=24, action_size=2, seed=10):
        """
        Params
        ======
